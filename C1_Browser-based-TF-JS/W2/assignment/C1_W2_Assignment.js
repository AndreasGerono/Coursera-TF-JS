...
function getModel() {
    ...
    model.add(tf.layers.conv2d({inputShape: [28, 28, 1], kernelSize: 5, filters: 32, activation: 'relu'}));
    model.add(tf.layers.maxPooling2d({poolSize: [2, 2]}));
    model.add(tf.layers.conv2d({filters: 64, kernelSize: 5, activation: 'relu'}));
    model.add(tf.layers.maxPooling2d({poolSize: [2, 2]}));
